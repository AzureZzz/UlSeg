...
from .decoder import DeepLabV3Decoder, DeepLabV3PlusDecoder, DeepLabV3PlusDecoderBeta
...
class DeepLabV3PlusBeta(SegmentationModel):
...
Convolution for Semantic Image Segmentation"
    ...
    def __init__(
        ...
        self.decoder = DeepLabV3PlusDecoderBeta(
