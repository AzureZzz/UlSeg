...
if __name__ == '__main__':
    ...
    # 路径设置
    img_path = r'dataset/our_large/preprocessed/stage1/p_image'
    ...
    with torch.no_grad():
        ...
        model_cascade2 = torch.nn.DataParallel(model_cascade2)
                ...
                with torch.no_grad():
                    ...
                    with torch.no_grad():
                        if use_c2_flag:
                            ...
                            dim1_cut_min, dim1_cut_max, dim2_cut_min, dim2_cut_max = preprocess(mask_c1_array_biggest,
                                                                                                c1_size)
                    ...
                    GT_array = (GT_array > 0.5).astype(np.float32)
